...
// bool CheckNumber (int[,] newArray, int x)
// {
...
//     else
// {
//     Console.WriteLine($"Число {x} отсутствует в массиве");
// }    
...
// void ArithmeticMean(int[,] newArray)
// {
...
//          }
// 	   middle = Math.Round (sum / newArray.GetLength(0),2);
...
//             else
//             Console.WriteLine($"Значение элемента {newArray[i,j]}");  
//         }
